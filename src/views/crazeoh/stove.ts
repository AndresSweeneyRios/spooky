...
export class StoveView extends View {
  ...
  public Draw(simulation: Simulation, lerpFactor: number): void {
    ...
    if (!this.isOpen) {
      this.doorBone.rotation.x =
        STOVE_OPEN_ANGLE + (STOVE_CLOSED_ANGLE - STOVE_OPEN_ANGLE) * percentage;
    } else {
      this.doorBone.rotation.x =
        STOVE_CLOSED_ANGLE + (targetAngle - STOVE_CLOSED_ANGLE) * percentage;
    }
  }
