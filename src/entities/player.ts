...
export const createPlayer = (
  ...
  simulation.SimulationState.PhysicsRepository.CreateCharacterControllerWithSphere(
    entId,
    positionAtFeet,
    size - offset,
    offset
  );
  simulation.SimulationState.PhysicsRepository.SetAffectedByGravity(
    entId,
    true
  );
  ...
  simulation.SimulationState.StatRepository.SetStatBaseValue(
    entId,
    StatType.SPEED,
    SPEED
  );
