...
const battleScene = initializeSubScene(
  () => import("../lordOfHosts/dracBattle")
);
...
export const init = async () => {
  ...
  crtPass.uniforms.rgbOffset = { value: new THREE.Vector3(0.0, 0.0, 0.0) };
