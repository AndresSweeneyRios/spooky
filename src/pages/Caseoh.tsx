...
import {
  getMasterVolumePercentage,
  setMasterVolumeFromPercentage,
} from "../audio/volume";
...
export const setPickerVisibility = (visible: boolean) => {
  ...
  if (visible) {
    const yes = document.querySelector(
      "#caseoh-decision .yes button"
    ) as HTMLElement;
    const no = document.querySelector(
      "#caseoh-decision .no button"
    ) as HTMLElement;
    const cancel = document.querySelector(
      "#caseoh-decision .cancel button"
    ) as HTMLElement;
      ...
      leftAction() {
        ...
        if (currentSensitivity > 0) {
          ...
          localStorage.setItem(
            "sensitivity",
            (parseFloat(sensitivityInput.value) / 100).toString()
          );
        }
      },
...
export const setAreYouSureVisibility = (visible: boolean) => {
  ...
  if (visible) {
    const yesButton = document.querySelector(
      "#caseoh-settings .are-you-sure button:first-child"
    ) as HTMLButtonElement;
    const noButton = document.querySelector(
      "#caseoh-settings .are-you-sure button:last-child"
    ) as HTMLButtonElement;
        ...
        <div id="caseoh-settings" is-hidden="true">
          ...
          <div className="caseoh-setting">
            ...
            <input
              ...
              step="1"
              defaultValue={
                parseFloat(localStorage.getItem("sensitivity")!) * 100
              }
              onChange={(e) => {
                localStorage.setItem(
                  "sensitivity",
